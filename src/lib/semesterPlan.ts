...
export const SEMESTER: SemesterWeek[] = [
  { n: 1, from: "2026-08-19", to: "2026-08-23",
    focus: "Exam 1 sprint. Both exams moved back two days — Biochem is now Wed 8/26, CMB Thu 8/27, each a midnight-to-10am window. Biochem: buffers, amino acids, proteins, enzymes I and II. CMB: cell structure, culture and stem cells, signalling I and II, cell cycle, cancer. Quiz 1 no longer counts, so rework the misses to learn the material, not to chase the points.",
    getAhead: "Micro flashcards 20 min daily: bacterial cytology and physiology. CMB Exam 1 review is live Friday 8am — attend it." },
  { n: 2, from: "2026-08-24", to: "2026-08-30", heavy: true,
    focus: "Biochem Exam 1 Wednesday, CMB Exam 1 Thursday — both windowed midnight to 10am, so sit them early and keep the workday. Physio and Micro reviews are live Thursday and Friday. After Thursday pivot hard to Physio (fluid homeostasis, membrane transport, NMJ and muscle, heart and circulation) and Micro (cytology, physiology, antimicrobials, gene regulation, microbial variation, genetic exchange) — those exams are 8/31 and 9/1 and they did not move.",
    getAhead: "CMB Quiz 2 topics: DNA structure, chromatin, replication" },
  { n: 3, from: "2026-08-31", to: "2026-09-06", heavy: true,
    focus: "Physio Exam 1 Monday 8am, Micro Exam 1 Tuesday 8am — both fixed sittings, neither moved. Then CMB Quiz 2 Friday. Two exams then a quiz in five days: CMB Quiz 2 prep happens Wednesday and Thursday only, so it must already be loaded before Monday.",
    getAhead: "Biochem Quiz 2: metabolism basics, carbohydrates, glycolysis, TCA" },
  { n: 4, from: "2026-09-07", to: "2026-09-13",
    focus: "Breathing room — the only real gap all semester, and Labor Day Monday is a free day on top of it. Use both. Biochem metabolism plus a full head start on next week's three-quiz pile-up. Start the Micro immunology deck now.",
  ...
  { n: 6, from: "2026-09-21", to: "2026-09-27", heavy: true,
    focus: "CMB Exam 2 Tuesday covers exactly what Quizzes 2 and 3 just covered, so Monday is error-log review only, not relearning. Wednesday is Student Research Day, no class — a free study day right in the middle. Then Biochem oxidative phosphorylation, PPP, glycogen for Quiz 3 Friday.",
  ...
  { n: 8, from: "2026-10-05", to: "2026-10-11", heavy: true,
    focus: "The hardest week of the term — Micro Exam 2 Tuesday, CMB Quiz 4 Wednesday, Physio Exam 2 Friday. 50 percentage points plus a quiz. No new learning this week, only review of W6 and W7 work. Monday is Convocation, no class — that is a full prep day the day before Micro Exam 2, not a day off. Take PTO Oct 5–9 if you can get it.",
