...
Start with "4pm check-in —"`,
    ...
    const text = msg.content[0].type === "text" ? msg.content[0].text : "4pm check-in — how are you doing on your 75 Hard goals today?";
    ...
    await sendPushNotification(data, "4pm Check-in", text);
