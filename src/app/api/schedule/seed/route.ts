...
const TEMPLATE: Series[] = [
  ...
  { cal: "primary", summary: "🧑‍⚕️ Therapy", desc: "Wednesday 11am — anchored to the WFH no-driving day. Overlaps Physiology, catch the recording after.", anchor: "2026-08-05", start: "11:00", end: "12:00", rrule: "RRULE:FREQ=WEEKLY;BYDAY=WE", remindMin: 30 },
