    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl p-6" style={{ background: "var(--surface)", border: "1.5px solid var(--border)" }}>
        ...
        <input
          ...
          type="file"
          multiple
          accept="video/*,audio/*,.pdf,application/pdf,.pptx,application/vnd.openxmlformats-officedocument.presentationml.presentation,.docx,application/vnd.openxmlformats-officedocument.wordprocessingml.document,.html,.htm,text/html,.txt,.md"
          className="hidden"
        ...
        <input
          ref={slidesInput}
          type="file"
          accept=".pdf,application/pdf,.pptx,application/vnd.openxmlformats-officedocument.presentationml.presentation,.docx,application/vnd.openxmlformats-officedocument.wordprocessingml.document,.html,.htm,text/html,.txt,.md"
          className="hidden"
          onChange={e => {
                ...
                <div className="mt-2 space-y-1">
                  ...
                  {it.status === "waiting" ? (
                    <button onClick={() => pickSlidesFor("queue", it.key)}
                      ...
                      {it.slidesFiles?.length ? "Add another deck" : "Add the slides for this lecture (PDF, Word, .pptx, HTML)"}
                    </button>
