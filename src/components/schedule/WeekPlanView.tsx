...
const WEEK: Record<number, { name: string; blocks: Block[] }> = {
  1: { name: "Monday", blocks: [
    ...
    { start: "07:00", end: "14:30", label: "Work + classes (capture mode)", cat: "work", note: "Heights doses at 10:00 & 1:30 · flashcards in gaps" },
    { start: "14:30", end: "15:20", label: "Extended-route drive home", cat: "exposure", note: "Driving exposure #1 — no time pressure" },
    { start: "15:20", end: "17:00", label: "Classes stream · light tasks", cat: "work" },
  ...
  2: { name: "Tuesday", blocks: [
    ...
    { start: "06:10", end: "07:00", label: "Shower, ready, breakfast", cat: "rest" },
    { start: "07:00", end: "14:30", label: "Work + classes (capture mode)", cat: "work", note: "Heights doses at 10:00 & 1:30" },
    { start: "14:30", end: "15:00", label: "Drive home — direct", cat: "work" },
    { start: "15:00", end: "17:00", label: "Classes stream · flashcards, light tasks", cat: "work" },
  ...
  3: { name: "Wednesday · WFH", blocks: [
    ...
    { start: "07:00", end: "12:00", label: "Work from home + classes", cat: "work" },
    ...
    { start: "15:00", end: "17:00", label: "Classes stream + cook Thu/Fri meals", cat: "life" },
  ...
  4: { name: "Thursday", blocks: [
    ...
    { start: "06:10", end: "07:00", label: "Shower, ready, breakfast", cat: "rest" },
    { start: "07:00", end: "14:30", label: "Work + classes (capture mode)", cat: "work", note: "Heights doses at 10:00 & 1:30" },
    { start: "14:30", end: "16:30", label: "Home · classes stream · light tasks", cat: "work" },
  ...
  5: { name: "Friday", blocks: [
    ...
    { start: "06:10", end: "07:00", label: "Shower, ready, breakfast", cat: "rest" },
    { start: "07:00", end: "14:30", label: "Work + classes", cat: "work" },
