...
const SECTIONS = [
  ...
  { key: "psychSoc" as const, label: "Psych/Soc", color: "rgba(180,85,47,0.3)" },
];
          ...
          <div className="h-48 mt-2">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={studyChartData}>
                <CartesianGrid strokeDasharray="3 3" stroke="rgba(180,85,47,0.1)" />
                <XAxis dataKey="date" tick={{ fontSize: 11, fill: "#A8967E" }} />
                <YAxis tick={{ fontSize: 11, fill: "#A8967E" }} />
                <Tooltip contentStyle={{ background: "var(--surface)", border: "1px solid rgba(180,85,47,0.1)", borderRadius: "8px", fontSize: "12px" }} />
